...
declare -A SEEN=()
INCLUDE_REGEX=${MYPY_INCLUDE_REGEX:-^backend/app/((utils|schemas)/.*\.py|services/(a2a_stream_diagnostics|interrupt_metadata_normalization|invoke_guard)\.py|core/(config|http_client)\.py|db/session\.py)$}
