...
class MemoryStreamCache:
    ...
    async def append_event(self, cache_key: str, event: Dict[str, Any], sequence: int) -> None:
    ...
    async def get_events_after(self, cache_key: str, sequence: int) -> List[Dict[str, Any]]:
