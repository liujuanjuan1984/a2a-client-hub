"""Shared Hub Assistant agents service built on top of personal-agent services."""
...
from app.features.agents.personal.service import (
...
class HubAssistantAgentsService:
    """Shared agent operations for REST, CLI, and Hub Assistant entry points."""
    ...
    async def list_agents(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_AGENTS_LIST,
    ...
    async def get_agent(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_AGENTS_GET,
    ...
    async def check_agent_health(
        ...
        *,
        ...
        del db
        result = await gateway.execute(
            operation=HUB_ASSISTANT_AGENTS_CHECK_HEALTH,
            resource_id=str(agent_id),
    ...
    async def check_all_agents_health(
        ...
        *,
        ...
        del db
        result = await gateway.execute(
            operation=HUB_ASSISTANT_AGENTS_CHECK_HEALTH_ALL,
            handler=lambda: a2a_agent_service.check_agents_health(
                user_id=self._user_id(current_user),
                force=force,
            ),
    ...
    async def create_agent(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_AGENTS_CREATE,
    ...
    async def update_config(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_AGENTS_UPDATE_CONFIG,
            resource_id=str(agent_id),
    ...
    async def delete_agent(
        ...
        *,
        ...
        await gateway.execute(
            operation=HUB_ASSISTANT_AGENTS_DELETE,
            resource_id=str(agent_id),
...
hub_assistant_agents_service = HubAssistantAgentsService()
