"""Shared Hub Assistant jobs service built on top of schedule domain services."""
...
class HubAssistantJobsService:
    """Shared job operations for REST, CLI, and Hub Assistant entry points."""
    ...
    async def list_jobs(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_LIST,
    ...
    async def get_job(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_GET,
    ...
    async def create_job(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_CREATE,
    ...
    async def pause_job(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_PAUSE,
            resource_id=str(task_id),
    ...
    async def resume_job(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_RESUME,
            resource_id=str(task_id),
            handler=lambda: a2a_schedule_service.set_enabled(
                db,
                user_id=self._user_id(current_user),
    ...
    async def update_job(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_UPDATE,
            resource_id=str(task_id),
    ...
    async def update_prompt(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_UPDATE_PROMPT,
            resource_id=str(task_id),
            handler=lambda: a2a_schedule_service.update_task(
                db,
                user_id=self._user_id(current_user),
    ...
    async def update_schedule(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_UPDATE_SCHEDULE,
            resource_id=str(task_id),
            handler=lambda: a2a_schedule_service.update_task(
                db,
                user_id=self._user_id(current_user),
    ...
    async def delete_job(
        ...
        *,
        ...
        result = await gateway.execute(
            operation=HUB_ASSISTANT_JOBS_DELETE,
            resource_id=str(task_id),
...
hub_assistant_jobs_service = HubAssistantJobsService()
