...
_DEFAULT_SYSTEM_PROMPT = (
    ...
    "agent's final reply, do not invent downstream outcomes, and explain that "
    "the request was handed off to the target conversation. When the current "
    "task requires follow-up, inspect persisted target-session text messages "
    "through the available session read tools before reporting back."
)
