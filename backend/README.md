...
- `backend/app/integrations/a2a_client/__init__.py`
- `backend/app/integrations/a2a_client/config.py`
- `backend/app/integrations/a2a_client/gateway.py`
- `backend/app/integrations/a2a_client/http_clients.py`
- `backend/app/integrations/a2a_client/invoke_session.py`
- `backend/app/integrations/a2a_client/resolution.py`
- `backend/app/integrations/a2a_client/registry.py`
- `backend/app/integrations/a2a_client/selection.py`
- `backend/app/integrations/a2a_client/service.py`
- `backend/app/integrations/a2a_client/session_factory.py`
- `backend/app/integrations/a2a_client/types.py`
- `backend/app/integrations/a2a_client/adapters/base.py`
- `backend/app/integrations/a2a_client/adapters/jsonrpc_pascal.py`
- `backend/app/integrations/a2a_client/adapters/jsonrpc_slash.py`
- `backend/app/integrations/a2a_client/adapters/sdk.py`
- `backend/app/integrations/a2a_extensions/__init__.py`
