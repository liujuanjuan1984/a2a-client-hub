...
- Read generic extension capabilities:
  ...
  - Inside the backend adapter layer, provider-scoped metadata routing is treated as adapter-local namespace state rather than a public capability contract; public responses remain Hub-stable.
