...
from app.features.agents.shared.runtime import SharedAgentUserCredentialRequiredError
...
async def test_list_catalog_reads_persisted_shared_and_builtin_snapshots(
    ...
    monkeypatch.setattr(
        "app.features.agents.catalog.service.a2a_agent_service.list_all_agents",
        _fake_list_all_agents,
    )
    monkeypatch.setattr(
        "app.features.agents.catalog.service.shared_agent_service.list_visible_agents_for_user",
        _fake_list_visible_agents_for_user,
    )
    monkeypatch.setattr(
        "app.features.agents.catalog.service.hub_assistant_service.get_profile",
...
async def test_check_catalog_health_persists_shared_and_builtin_snapshots(
    ...
    monkeypatch.setattr(
        "app.features.agents.catalog.service.a2a_agent_service.check_agents_health",
    ...
    monkeypatch.setattr(
        "app.features.agents.catalog.service.shared_agent_runtime_builder.build",
        _fake_build,
    )
    monkeypatch.setattr(
        "app.features.agents.catalog.service.fetch_and_validate_agent_card",
        _fake_validate,
    )
    monkeypatch.setattr(
        "app.features.agents.catalog.service.get_a2a_service",
...
async def test_check_catalog_health_marks_missing_shared_credential_unavailable(
    ...
    async def _fake_build(db, *, user_id, agent_id):
        raise SharedAgentUserCredentialRequiredError("User credential required")
