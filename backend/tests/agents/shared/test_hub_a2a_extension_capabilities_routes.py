    ...
    fake_extensions.capability_snapshot = SimpleNamespace(
        ...
        interrupt_recovery=SimpleNamespace(
            ...
            ext=SimpleNamespace(
                ...
                uri="urn:opencode-a2a:extension:interrupt-recovery:v1",
            ),
        ),
        ...
        compatibility_profile=SimpleNamespace(
            ...
            error=None,
            ext=SimpleNamespace(
                uri="urn:opencode-a2a:extension:compatibility-profile:v1",
                extension_retention={
                    "urn:opencode-a2a:extension:session-management:v1": SimpleNamespace(
                    ...
                    "urn:opencode-a2a:extension:interrupt-recovery:v1": SimpleNamespace(
                        surface="jsonrpc-extension",
                        availability="always",
                        retention="stable",
                        extension_uri=None,
                ...
                method_retention={
                    "opencode.sessions.shell": SimpleNamespace(
                        ...
                        extension_uri="urn:opencode-a2a:extension:session-management:v1",
                        toggle="A2A_ENABLE_SESSION_SHELL",
                        implementation_scope=None,
                        identity_scope=None,
                        upstream_stability=None,
