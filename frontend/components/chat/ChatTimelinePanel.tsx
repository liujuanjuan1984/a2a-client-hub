  ...
  return (
    <>
      {session?.streamState === "recoverable" ? (
        <View className="mx-3 sm:mx-6 mt-3 flex-row items-center rounded-xl border border-yellow-500/30 bg-yellow-500/10 px-3 py-2">
      ...
      {session?.streamState === "error" ? (
        <View className="mx-3 sm:mx-6 mt-3 rounded-xl border border-red-500/30 bg-red-500/10 px-3 py-2">
      ...
      <FlatList
        ref={listRef}
        className="mt-2 flex-1 px-3 sm:px-6"
        data={messages ?? []}
